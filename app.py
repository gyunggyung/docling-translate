...
def main():
    ...
    with st.sidebar:
        ...
        engine = st.selectbox(t("engine_label"), ["google", "deepl", "gemini", "openai", "qwen-0.6b", "lfm2", "yanolja"], index=0)
        
        default_workers = 1 if engine in ["qwen-0.6b", "lfm2", "yanolja"] else 8
