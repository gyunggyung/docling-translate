...
def main():
    ...
    parser.add_argument("--engine", default="google", choices=["google", "deepl", "gemini", "openai", "qwen-0.6b", "lfm2", "lfm2-koen-mt", "yanolja"], help="Translation engine (default: google)")
    ...
    if args.engine in ["qwen-0.6b", "lfm2", "lfm2-koen-mt", "yanolja"] and workers == 8:
