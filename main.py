...
def main():
    ...
    parser.add_argument("--engine", default="google", choices=["google", "deepl", "gemini", "openai", "qwen-0.6b", "lfm2", "yanolja"], help="Translation engine (default: google)")
    ...
    if args.engine in ["qwen-0.6b", "lfm2", "yanolja"] and workers == 8:
